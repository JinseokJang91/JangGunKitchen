...
const thumbnailUrl = computed(() => {
    return resolveRecipeImage(props.recipe.thumbnail);
});
        ...
        <div class="p-4">
            ...
            <div v-if="showAuthor" class="recipe-list-item__author-row">
                <div class="recipe-list-item__author">
                    <img v-if="recipe.memberProfileImage" :src="resolveProfileImage(recipe.memberProfileImage)" :alt="recipe.memberNickname || recipe.memberName" class="w-8 h-8 rounded-full" />
