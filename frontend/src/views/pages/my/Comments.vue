...
import { resolveMediaUrl, resolveRecipeImage } from '@/utils/image';
                        ...
                        >
                            ...
                            <div class="comment-card__recipe">
                                <div class="comment-card__recipe-thumb">
                                    <img :src="resolveRecipeImage(item.recipeThumbnail)" :alt="item.recipeTitle" class="comment-card__recipe-img" />
                                </div>
                            ...
                            <div class="comment-card__comment">
                                ...
                                <div v-if="item.comment.imageUrl" class="comment-card__comment-image-wrap">
                                    <img :src="resolveMediaUrl(item.comment.imageUrl)" alt="댓글 이미지" class="comment-card__comment-image" />
                                </div>
