...
본 문서는 JangGunKitchen 애플리케이션에 **구현된 기능**을 분석하여 도출한 기능·비기능 요구사항을 정의한다.  
요구사항은 실제 구현된 화면·API·도메인 기능을 기준으로 정리하였다.

### 1.2 적용 범위

- **대상**: JangGunKitchen 웹 애플리케이션 (프론트엔드 Vue 3 + 백엔드 Spring Boot 단일 앱)
...
| REQ-ADM-03 | 테마 컬렉션 관리 | ~~테마 생성·테마에 레시피 추가/제거~~ | 기능 | - | 삭제됨 | 2026-08-29 제거 |
