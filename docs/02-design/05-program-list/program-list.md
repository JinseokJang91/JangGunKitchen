...
**작성 기준**: Frontend `frontend/src/`, Backend `backend/app/src/main/java/` 소스 파일 (build/generated 제외)  
...
| 3 | BE-AUTH-003 | Service | 토큰 서비스 | app/.../auth/api/service/TokenService.java | JWT 발급·검증·리프레시·블랙리스트 | - |
| 4 | BE-AUTH-004 | Service | 네이버 인증 서비스 | app/.../auth/api/service/NaverAuthService.java | 네이버 OAuth 사용자 정보 조회 | - |
| 5 | BE-AUTH-005 | Service | 카카오 인증 서비스 | app/.../auth/api/service/KakaoAuthService.java | 카카오 OAuth 사용자 정보 조회 | - |
| 6 | BE-AUTH-006 | Service | 구글 인증 서비스 | app/.../auth/api/service/GoogleAuthService.java | 구글 OAuth 사용자 정보 조회 | - |
| 7 | BE-AUTH-007 | Repository | 리프레시토큰 저장소 | app/.../auth/api/repository/RefreshTokenRepository.java | 리프레시 토큰 CRUD | refresh_tokens |
| 8 | BE-AUTH-008 | Repository | 토큰블랙리스트 저장소 | app/.../auth/api/repository/TokenBlacklistRepository.java | 블랙리스트 토큰 조회/저장 | token_blacklist |
| 9 | BE-AUTH-009 | Entity | 리프레시토큰 엔티티 | app/.../auth/api/entity/RefreshToken.java | 리프레시 토큰 테이블 매핑 | refresh_tokens |
| 10 | BE-AUTH-010 | Entity | 토큰블랙리스트 엔티티 | app/.../auth/api/entity/TokenBlacklist.java | 토큰 블랙리스트 테이블 매핑 | token_blacklist |
| 11 | BE-AUTH-011 | DTO | 카카오 사용자 DTO | app/.../auth/api/dto/KakaoUserDTO.java | 카카오 사용자 정보 | - |
| 12 | BE-AUTH-012 | DTO | 네이버 사용자 DTO | app/.../auth/api/dto/NaverUserDTO.java | 네이버 사용자 정보 | - |
| 13 | BE-AUTH-013 | DTO | 구글 사용자 DTO | app/.../auth/api/dto/GoogleUserDTO.java | 구글 사용자 정보 | - |
| 14 | BE-AUTH-014 | Request | 테스트 로그인 요청 | app/.../auth/api/request/TestLoginRequest.java | 테스트 로그인 요청 바디 | - |
| 15 | BE-AUTH-015 | Response | 토큰 응답 | app/.../auth/api/response/TokenResponse.java | 액세스/리프레시 토큰 응답 | - |
| 16 | BE-AUTH-016 | Utils | 쿠키 유틸 | app/.../auth/api/utils/CookieUtils.java | 쿠키 설정/삭제 | - |
| 17 | BE-AUTH-017 | Utils | 로그인 포맷터 | app/.../auth/api/utils/LoginFormatter.java | 로그인 ID 포맷 | - |

* 파일경로 상단 생략: `backend/app/src/main/java/com/janggunkitchen/auth/`
...
* 파일경로 상단 생략: `backend/app/src/main/java/com/janggunkitchen/common/`
...
| No | 프로그램ID | 구분 | 프로그램명 | 파일경로 | 설명 | 비고 |
|----|------------|------|------------|----------|------|------|
| 2 | BE-MEM-002 | Controller | 회원 API 컨트롤러 | app/.../member/api/web/MemberController.java | 내 정보·프로필·회원 조회·프로필 수정 | member |
| 3 | BE-MEM-003 | Controller | 팔로우 API 컨트롤러 | app/.../member/api/web/FollowController.java | 팔로우/언팔로우·팔로워·팔로잉 목록 | follow |
| 4 | BE-MEM-004 | Controller | 문의 API 컨트롤러 | app/.../member/api/web/InquiryController.java | 문의 등록·조회·수정·삭제·관리자 답변 | inquiry, inquiry_reply |
| 5 | BE-MEM-005 | Service | 회원 서비스 | app/.../member/api/service/MemberService.java | 회원 조회·프로필 수정 | - |
| 6 | BE-MEM-006 | Service | 팔로우 서비스 | app/.../member/api/service/FollowService.java | 팔로우/언팔로우·목록 조회 | - |
| 7 | BE-MEM-007 | Service | 문의 서비스 | app/.../member/api/service/InquiryService.java | 문의 CRUD·답변 | - |
| 8 | BE-MEM-008 | Repository | 문의 저장소 | app/.../member/api/repository/InquiryRepository.java | 문의 조회 | inquiry |
| 9 | BE-MEM-009 | Repository | 문의답변 저장소 | app/.../member/api/repository/InquiryReplyRepository.java | 답변 조회 | inquiry_reply |
| 10 | BE-MEM-010 | Repository | 문의이미지 저장소 | app/.../member/api/repository/InquiryImageRepository.java | 문의 이미지 | inquiry_image |
| 11 | BE-MEM-011 | Entity | 문의 엔티티 | app/.../member/api/entity/Inquiry.java | 문의 테이블 매핑 | inquiry |
| 12 | BE-MEM-012 | Entity | 문의답변 엔티티 | app/.../member/api/entity/InquiryReply.java | 문의 답변 테이블 매핑 | inquiry_reply |
| 13 | BE-MEM-013 | Entity | 문의이미지 엔티티 | app/.../member/api/entity/InquiryImage.java | 문의 이미지 테이블 매핑 | inquiry_image |
| 14 | BE-MEM-014 | DTO | 회원 DTO | app/.../member/api/dto/MemberDto.java | 회원 정보 응답 | - |
| 15 | BE-MEM-015 | DTO | 팔로우 DTO | app/.../member/api/dto/FollowDto.java | 팔로우 관계 | - |
| 16 | BE-MEM-016 | DTO | 팔로워 DTO | app/.../member/api/dto/FollowerDto.java | 팔로워 목록 | - |
| 17 | BE-MEM-017 | DTO | 팔로잉 DTO | app/.../member/api/dto/FollowingDto.java | 팔로잉 목록 | - |
| 18 | BE-MEM-018 | DTO | 문의 목록 항목 | app/.../member/api/dto/InquiryListItemDto.java | 문의 목록 한 행 | - |
| 19 | BE-MEM-019 | DTO | 문의 목록 응답 | app/.../member/api/dto/InquiryListResponse.java | 문의 목록 응답 | - |
| 20 | BE-MEM-020 | DTO | 문의 상세 DTO | app/.../member/api/dto/InquiryDetailDto.java | 문의 상세 조회 | - |
| 21 | BE-MEM-021 | DTO | 문의 답변 DTO | app/.../member/api/dto/InquiryReplyDto.java | 답변 내용 | - |

* 파일경로 상단 생략: `backend/app/src/main/java/com/janggunkitchen/member/`
...
| No | 프로그램ID | 구분 | 프로그램명 | 파일경로 | 설명 | 비고 |
|----|------------|------|------------|----------|------|------|
| 2 | BE-COOK-002 | Controller | 레시피 API 컨트롤러 | app/.../cook/api/recipe/web/RecipeController.java | 레시피 CRUD·목록·인기·팔로잉피드 | recipe 등 |
| 3 | BE-COOK-003 | Controller | 레시피 댓글 컨트롤러 | app/.../cook/api/recipe/web/RecipeCommentController.java | 댓글 등록·조회·수정·삭제 | recipe_comment |
| 4 | BE-COOK-004 | Controller | 레시피 북마크 컨트롤러 | app/.../cook/api/recipe/web/RecipeBookmarkController.java | 북마크·레시피북 내 북마크·이동·메모 | recipe_bookmark, recipebook |
...
| 17 | BE-COOK-017 | Service | 레시피 서비스 | app/.../cook/api/recipe/domain/service/RecipeService.java | 레시피 CRUD·목록·인기·팔로잉피드 | - |
| 18 | BE-COOK-018 | Service | 레시피 댓글 서비스 | app/.../cook/api/recipe/domain/service/RecipeCommentService.java | 댓글 CRUD | - |
| 19 | BE-COOK-019 | Service | 레시피 북마크 서비스 | app/.../cook/api/recipe/domain/service/RecipeBookmarkService.java | 북마크·이동·메모 | - |
...
| 31 | BE-COOK-031 | Service | 인기도 계산 서비스 | app/.../cook/api/popular/domain/service/PopularityCalculationService.java | 인기 점수 계산(배치) | recipe_popularity |
| 32 | BE-COOK-032 | Service | 인기 레시피 서비스 | app/.../cook/api/popular/domain/service/PopularRecipeService.java | 인기 레시피 조회 | recipe_popularity |
| 33 | BE-COOK-033 | Repository | 레시피 저장소 | app/.../cook/api/recipe/domain/repository/RecipeRepository.java | 레시피 조회 | recipe |
| 34 | BE-COOK-034 | Repository | 레시피 커스텀/구현 | app/.../cook/api/recipe/domain/repository/RecipeRepositoryCustom.java, RecipeRepositoryImpl.java | 동적 쿼리 | recipe |
| 35 | BE-COOK-035 | Repository | 레시피 댓글 저장소 | app/.../cook/api/recipe/domain/repository/RecipeCommentRepository.java | recipe_comment |
| 36 | BE-COOK-036 | Repository | 레시피북 저장소 | app/.../cook/api/recipe/domain/repository/RecipeBookRepository.java | recipebook |
| 37 | BE-COOK-037 | Repository | 레시피 북마크 저장소 | app/.../cook/api/recipe/domain/repository/RecipeBookmarkRepository.java | recipe_bookmark |
| 38 | BE-COOK-038 | Repository | 레시피 카테고리 저장소 | app/.../cook/api/recipe/domain/repository/RecipeCategoryRepository.java | recipe_category |
| 39 | BE-COOK-039 | Repository | 레시피 찜 저장소 | app/.../cook/api/recipe/domain/repository/RecipeFavoriteRepository.java | recipe_favorite |
| 40 | BE-COOK-040 | Repository | 레시피 이미지 저장소 | app/.../cook/api/recipe/domain/repository/RecipeImageRepository.java | recipe_image |
| 41 | BE-COOK-041 | Repository | 레시피 재료그룹/항목 저장소 | app/.../cook/api/recipe/domain/repository/RecipeIngredientGroupRepository.java, RecipeIngredientItemRepository.java | recipe_ingredient_* |
| 42 | BE-COOK-042 | Repository | 레시피 인기도/이력 저장소 | app/.../cook/api/recipe/domain/repository/RecipePopularityRepository.java, RecipePopularityHistoryRepository.java | recipe_popularity* |
...
| 50 | BE-COOK-050 | Entity | 레시피 카테고리 엔티티 | app/.../cook/api/recipe/domain/entity/RecipeCategory.java, RecipeCategoryId.java | recipe_category |
| 51 | BE-COOK-051 | Entity | 레시피 재료 그룹/항목 엔티티 | app/.../cook/api/recipe/domain/entity/RecipeIngredientGroup.java, RecipeIngredientItem.java | recipe_ingredient_* |
| 52 | BE-COOK-052 | Entity | 레시피 댓글 엔티티 | app/.../cook/api/recipe/domain/entity/RecipeComment.java | recipe_comment |
| 53 | BE-COOK-053 | Entity | 레시피 찜 엔티티 | app/.../cook/api/recipe/domain/entity/RecipeFavorite.java | recipe_favorite |
| 54 | BE-COOK-054 | Entity | 레시피 조회 엔티티 | app/.../cook/api/recipe/domain/entity/RecipeView.java | recipe_view |
...
| 65 | BE-COOK-065 | Enum | 레시피 상태/공개범위 | app/.../cook/api/recipe/domain/enums/Status.java, Visibility.java | 공개/비공개 등 | - |

* 파일경로 상단 생략: `backend/app/src/main/java/com/janggunkitchen/cook/`  
...
| 5 | FE-VW-005 | 내 레시피 목록 | views/pages/my/Recipes.vue | 내가 작성한 레시피 | /my/recipes |
...
| 31 | FE-VW-031 | 프로필(내) | views/pages/my/Profile.vue | 내 프로필 수정(마이페이지 탭) | /my?tab=profile |
| 32 | FE-VW-032 | 내 댓글 | views/pages/my/Comments.vue | 내 댓글 목록 | /my?tab=comments |
| 33 | FE-VW-033 | 내 문의 | views/pages/my/Inquiries.vue | 내 1:1 문의 목록 | /my?tab=inquiries |
| 34 | FE-VW-034 | 찜 목록 | views/pages/my/Favorites.vue | 찜한 레시피 목록 | /my?tab=favorites |
| 35 | FE-VW-035 | 404 | views/pages/error/NotFound.vue | 페이지 없음 | /error/notfound |
| 36 | FE-VW-036 | 접근 거부 | views/pages/error/Access.vue | 403 | /error/access |
| 37 | FE-VW-037 | 오류 | views/pages/error/Error.vue | 일반 오류 | /error/error |
...
| 31 | FE-TYPE-007 | Types | 테마 타입 | ~~types/theme.ts~~ | - | 삭제됨 |
